...
public final class ModItems {
    ...
    public static final DeferredItem<SpecialSwordItem> BLAZE_BLADE = specialSword("blazeblade", Tiers.DIAMOND, 1200, 4, false);
    public static final DeferredItem<SpecialSwordItem> ICE_HOLD = specialSword("icehold", Tiers.DIAMOND, 1200, 4, false);
    public static final DeferredItem<SpecialSwordItem> ASMO_SLASHER = specialSword("asmoslasher", Tiers.DIAMOND, 1200, 4, false);
    public static final DeferredItem<SpecialSwordItem> PLANET_GUARDIAN = specialSword("planetguardian", Tiers.DIAMOND, 1200, 4, false);
    public static final DeferredItem<SpecialSwordItem> STORM_BRINGER = specialSword("stormbringer", Tiers.DIAMOND, 1200, 4, false);
    public static final DeferredItem<NegiItem> NEGI = ITEMS.register("negi", NegiItem::new);
    public static final DeferredItem<SpecialSwordItem> LUCK_LUCK = specialSword("luckluck", Tiers.GOLD, 77, 2, false);
    public static final DeferredItem<SpecialSwordItem> SMASH_BAT = specialSword("smashbat", Tiers.WOOD, 95, 1, false);
    public static final DeferredItem<SpecialSwordItem> DEVIL_SWORD = specialSword("devilsword", Tiers.DIAMOND, 427, 1, false);
    public static final DeferredItem<SpecialSwordItem> HOLY_SABER = specialSword("holysaber", Tiers.GOLD, 280, 5, false);
